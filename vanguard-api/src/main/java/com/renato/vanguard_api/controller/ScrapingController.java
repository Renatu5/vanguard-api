...
public class ScrapingController {
    ...
    public ResponseEntity<String> singleCardScraping() {
        try {
            ...
            return ResponseEntity.ok("Scraping de uma carta iniciado com sucesso.");
        } catch (Exception e) {
            return ResponseEntity.internalServerError().body("Falha ao iniciar o scraping da carta: " + e.getMessage());
        }
    }
    ...
    public ResponseEntity<String> multipleCardsScraping() {
        try {
            ...
            return ResponseEntity.ok("Scraping de cartas iniciado com sucesso.");
        } catch (Exception e) {
            return ResponseEntity.internalServerError()
                    .body("Falha ao iniciar o scraping das cartas: " + e.getMessage());
        }
    }
